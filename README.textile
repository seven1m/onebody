...
*What It Isn't:* OneBody does not replace your church's standard membership database software (at least not yet). Our software is only useful when used in conjunction with your existing database. See "how it works":http://github.com/seven1m/onebody/wikis/HowItWorks.
