class UpdateSites < ActiveRecord::Migration
  def self.up
    change_table :sites do |t|
      ...
      t.boolean :import_export_enabled, :cms_enabled, :pictures_enabled, :publications_enabled, :default => true
  ...
  def self.down
    change_table :sites do |t|
      ...
      t.remove :import_export_enabled, :cms_enabled, :pictures_enabled, :publications_enabled
      t.remove :active
    end
  end
end
