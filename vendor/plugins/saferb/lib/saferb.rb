        ...
        if scanner.stag.nil?
          ...
          when '%>'
            ...
            when '<%='
              ...
              out.push("if (_erbcontent=(#{content}).to_s).tainted? and \"#{src}\" !~ /@exception|@contents|flash\\[/ and defined? params; raise \"unescaped string detected in ERB line: #{src}\"; else; #{@put_cmd}(_erbcontent); end")
            when '<%#'
