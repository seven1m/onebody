...
class PhotosControllerTest < ActionController::TestCase
  ...
  should "show a family photo" do
    @family.forge_photo
    get :show, {:family_id => @family.id}, {:logged_in_id => @person.id}
    assert_response :success
    # by size
    get :show, {:family_id => @family.id, :size => 'tn'}, {:logged_in_id => @person.id}
    assert_response :success
    # by size method
    get :medium, {:family_id => @family.id}, {:logged_in_id => @person.id}
    assert_response :success
  end
  ...
  should "show a person photo" do
    ...
    assert_response :success
    # by size
    get :show, {:person_id => @person.id, :size => 'large'}, {:logged_in_id => @person.id}
    assert_response :success
  end
  ...
  should "not show a person photo if the logged in user cannot see the person" do
    ...
    get :show, {:person_id => @child.id}, {:logged_in_id => @person.id}
    assert_response :missing
  end

  should "show a group photo" do
    @group = Group.forge(:photo => true)
    get :show, {:group_id => @group.id}, {:logged_in_id => @person.id}
    assert_response :success
  end
  ...
  should "show a picture photo" do
    ...
    get :show, {:album_id => @album.id, :picture_id => @picture.id}, {:logged_in_id => @person.id}
    assert_response :success
  end

  should "show a recipe photo" do
    @recipe = Recipe.forge(:photo => true)
    get :show, {:recipe_id => @recipe.id}, {:logged_in_id => @person.id}
    assert_response :success
  end
